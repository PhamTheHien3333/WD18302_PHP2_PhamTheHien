...
--
-- Máy chủ: localhost
-- Thời gian đã tạo: Th1 21, 2024 lúc 10:55 AM
...
INSERT INTO `posts` (`postId`, `title`, `content`, `date`, `topic`, `name`, `categoryId`, `userId`, `img`) VALUES
...
INSERT INTO `users` (`userId`, `username`, `email`, `password`, `name`, `role`, `img`) VALUES
...
--
ALTER TABLE `comments`
  ADD CONSTRAINT `FK1` FOREIGN KEY (`userId`) REFERENCES `users` (`userId`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `FK2` FOREIGN KEY (`postId`) REFERENCES `posts` (`postId`) ON DELETE CASCADE ON UPDATE CASCADE;
